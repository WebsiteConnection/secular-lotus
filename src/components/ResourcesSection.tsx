...
const resources = [
  ...
  },
  {
    ...
    icon: Headphones,
    url: "https://www.paper2audio.com/paper/An-Ultimate-from-Immanence-Lotus-Buddhism-Redefined-for-a-Secular-Worldview-Full-Text-bfa85a60-aa4b-42eb-8d9e-ce89e1bbe080"
  },
  {
    title: "Secular Prayers",
    description: <>Consider traditional liturgical practices adapted for a secular worldview.</>,
    icon: Heart,
  ...
  },
  {
    ...
    icon: Headphones,
    url: "https://www.paper2audio.com/paper/A-Secular-Buddhism-Based-on-the-Lotus-Sutra-Full-Text-5ba95073-9000-43e8-a1a9-b70028c3288e"
  },
  {
  ...
  {
    title: "The Secular Buddhist Movement",
    description: "Explore the current state of Secular Buddhism as a whole.",
    icon: Globe,
