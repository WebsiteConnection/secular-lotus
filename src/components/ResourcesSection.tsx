...
const resources = [
  {
    ...
    description: "Watch an eight-minute slide presentation that briefly explains the teachings.",
    icon: Play,
  ...
  },
  {
    ...
    description: "Consider how traditional liturgical practices based on the Lotus Sūtra can be adapted for a secular worldview.",
    icon: Heart,
